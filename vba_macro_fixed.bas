...
Public Sub 作成_総合実施計画書_最新患者のみ()
    ...
    Select Case doctorName
        Case "阪本"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\阪本Dr\"
        Case "八木"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\八木Dr\"
        Case "畠山"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\畠山Dr\"
        Case "岡田"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\岡田Dr\"
        Case "小川"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\小川Dr\"
        Case "香川", "鎌田"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\脳外科Dr\"
        Case Else
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\藤井　担当\整形外科Dr\"
    End Select
