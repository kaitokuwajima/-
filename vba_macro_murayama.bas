...
Public Sub 作成_総合実施計画書_最新患者のみ_村山担当()
    Dim ws As Worksheet
    ...
    Select Case doctorName
        Case "阪本"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\阪本先生\"
        Case "八木"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\八木先生\"
        Case "畠山"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\畠山先生\"
        Case "岡田"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\岡田先生\"
        Case "小川"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\小川先生\"
        Case "香川", "鎌田"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\鎌田先生.香川先生\"
        Case Else
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\村山　担当\総合計画書\Dr.別\その他先生\"
    End Select
