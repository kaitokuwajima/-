...
Public Sub 作成_総合実施計画書_最新患者のみ_石川担当()
    Dim ws As Worksheet
    ...
    Select Case doctorName
        Case "阪本"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\阪本Dr\"
        Case "八木"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\八木Dr\"
        Case "畠山"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\畠山Dr\"
        Case "岡田"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\岡田\"
        Case "小川"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\小川Dr\"
        Case "藤木"
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\藤木\"
        Case Else
            savePath = "\\dataserver\rehabilitation-ka\gairai\総計\石川担当\その他のdｒ\"
    End Select
